...
public class RequestHandler extends Thread {
	...
	public void run() {
		try {
			...
			if ("GET".equals(tokens[0])) {
				...
				respons404Error(outputStream, tokens[2]);
			}
	...
	private void respons404Error(OutputStream outputStream, String protocol) throws IOException {
	...
	private void responseStaticResource(OutputStream outputStream, String url, String protocol) throws IOException {
		...
		String mimc = Files.probeContentType(path);
